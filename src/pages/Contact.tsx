...
const Contact = () => {
    return (
        <div className="flex justify-center animate-slideInLeft">
            <div className="flex flex-col text-center ... bg-zinc-900 p-4 rounded relative mt-32 border-2 border-bisque-500">
                <div className='w-52 h-52 rounded-xl overflow-hidden mx-auto mb-5 absolute -top-28 left-1/2 transform -translate-x-1/2 border-2 border-bisque-500'>
                ...
                <div className='mt-24 mb-4'>
                    ...
                    <div className="info-container bg-bisque-850 rounded p-2 mt-4 mb-8 divide-y">
