        ...
        <div className="text-center animate-slideInLeft">
            <div className="flex items-stretch lg:items-center flex-col lg:flex-row p-6 bg-bisque-850 rounded-t-lg">
                ...
                <div className="flex-1 text-left p-6">
                    ...
                    <p className="pb-4">I have always been passionate about technology and everything that comes with it. While my interest started out in video games and their creation, in recent years I have become more fluid in my interests. Because of my love for video games and its wide use in the industry, I am quite proficient with using Unreal Engine. I have also written apps and websites using a combination of HTML, CSS and JavaScript and extended my knowledge with frameworks like Vue.js and React. I have also had experience with containerisation (Docker, Kubernetes), CI/CD and source control (Git).</p>
